...
public class Lab10Good {
	
	
	public static void main(String[] args) {
		//String[] expressions = {"391", "2002", "1444"};
		
		//two digit numbers: 10 thru 99
		...
		for (int i=10; i<100; i++) {
			for (int j=10; j<100; j++) {
					...
					if (i*j > biggest && isaPalindrome(Integer.toString(i*j)) ) {
						biggest = i*j;
						System.out.println(i*j);
					}
		...
		for (int i=0; i<nums.length; i++) {
			testPalindrome(Integer.toString(nums[i]));
		}
		*/
